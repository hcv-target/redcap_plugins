...
$tx_fragment_labels = array('ifn' => 'interferon', 'rib' => 'ribavirin', 'rbv' => 'ribavirin', 'tvr' => 'telaprevir', 'boc' => 'boceprevir', 'sim' => 'simeprevir', 'sof' => 'sofosbuvir', 'dcv' => 'daclatasvir', 'hvn' => 'harvoni', 'vpk' => 'ombitasvir', 'dbv' => 'dasabuvir');
$tx_prefixes = array('ifn', 'rib', 'tvr', 'boc', 'sim', 'sof', 'dcv', 'hvn', 'vpk', 'dbv');
$tx_prefixes_bms = array('rbv', 'sof', 'dcv');
$regimen_fields = array('reg_suppcm_regimen', 'ifn_cmstdtc', 'rib_cmstdtc', 'rbv_cmstdtc', 'boc_cmstdtc', 'tvr_cmstdtc', 'sim_cmstdtc', 'sof_cmstdtc', 'sof_exstdtc', 'dcv_exstdtc', 'dcv_cmstdtc', 'hvn_cmstdtc', 'vpk_cmstdtc', 'dbv_cmstdtc');
...
$tx_to_arm = array(
	...
	'RIB' => array('8' => array('RBV' => 'Ribavirin')),
	'RBV' => array('9' => array('RBV' => 'Ribavirin')),
	'BOC' => array('10' => array('BOC' => 'Boceprevir')),
	'TPV' => array('11' => array('TPV' => 'Telaprevir'))
);
$no_conversion = array();
 ...
 * VARS
 */
$dm_array = array('dm_rfstdtc', 'dm_brthyr', 'dm_race', 'dm_sex', 'age_suppvs_age', 'dis_suppfa_txendt', 'dis_dsstdy', 'hcv_suppfa_svr12dt', 'hcv_suppfa_svr24dt', 'eot_dsterm', 'dm_actarm', 'dm_actarmcd');
...
$daa_array = array('tvr_cmstdtc', 'sof_cmstdtc', 'sim_cmstdtc', 'boc_cmstdtc', 'dcv_cmstdtc', 'hvn_cmstdtc', 'vpk_cmstdtc', 'dbv_cmstdtc');
$chem_fields = array('chem_lbdtc', 'creat_lbstresn', 'crcl_lborres', 'chem_im_lbdtc', 'creat_im_lbstresn', 'crcl_im_lborres');
...
$GLOBALS['chem_fields'] = $chem_fields;
