 ...
 * VARS
 */
$dm_array = array('dm_rfstdtc', 'dm_brthyr', 'dm_race', 'dm_sex', 'age_suppvs_age', 'dm_rfendtc', 'dis_dsstdy', 'hcv_suppfa_svr12dt', 'hcv_suppfa_svr24dt');
...
foreach ($data AS $subject_id => $subject) {
	...
	if (isset($tx_start_date)) {
		 ...
		 * dm_rfendtc
		 */
		$endt_prefix_array = array('hvn', 'vpk', 'dbv', 'zep', 'rbv');
		$stack = array();
