...
$fields = array('dm_subjid', 'dm_usubjid', 'consent_dsstdtc', 'ae_aeser');
...
foreach ($data AS $subject_id => $subject) {
	 ...
	 * MAIN EVENT LOOP
	 */
	/*if ($subject[$Proj->firstEventId]['consent_dsstdtc'] != '' && $subject[$Proj->firstEventId]['consent_dsstdtc'] >= $filter_date) {
