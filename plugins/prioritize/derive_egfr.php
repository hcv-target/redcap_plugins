...
foreach ($data AS $subject_id => $subject) {
	 ...
	 */
	$creat_array = array();
	$tx_start_date = $subject[$first_event_id]['dm_rfstdtc'];
	$race = $subject[$first_event_id]['dm_race'];
	$sex = $subject[$first_event_id]['dm_sex'];
	$age = $subject[$first_event_id]['age_suppvs_age'];
