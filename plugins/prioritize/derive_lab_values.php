 ...
 */
$uln = 40;
$dm_array = array('dm_rfstdtc', 'dm_brthyr', 'dm_brthdtc', 'dm_race', 'dm_sex', 'age_suppvs_age', 'dm_rfendtc', 'dis_dsstdy', 'hcv_suppfa_svr12dt', 'hcv_suppfa_svr24dt');
...
foreach ($data AS $subject_id => $subject) {
	...
	$chem_values = array();
	$cbc_values = array();
	$sex = isset($subject[$first_event_id]['dm_sex']) ? $subject[$first_event_id]['dm_sex'] : 'F';
